"""Build Sabah FK squad from recent FotMob match lineups (squad page returns 500)."""
...
TEAM_ID = 951893
TEAM_NAME = "Sabah FK"
SQUAD_URL = "https://www.fotmob.com/en-GB/teams/951893/stats/sabah-fk/players"
...
def players_from_match(match_id: int) -> list[dict]:
    ...
    lu = data.get("content", {}).get("lineup") or {}
    rows = []
...
def main() -> None:
    ...
    print("Sabah FK finished matches to scan:", match_ids)
    by_id: dict[int, dict] = {}
    ...
    out_path = _REPO / "competitions/active/uefa-cl-2026-27/player-pool/squads/Sabah_FK_Squad.json"
