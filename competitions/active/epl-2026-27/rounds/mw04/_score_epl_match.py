...
# Force UTF-8 in child processes so non-ASCII player names don't crash
# Windows cp1252 console prints (cosmetic-only, but returns non-zero).
...
COMP_SLUG = "epl-2026-27"
ROUND_SLUG = "mw04"

MATCH_DIR = REPO / "competitions/active" / COMP_SLUG / "rounds" / ROUND_SLUG / "matches" / MATCH_SLUG
INTER = MATCH_DIR / "intermediates"
MS = REPO / "auction-app/data/competitions" / COMP_SLUG / "match-scores"
