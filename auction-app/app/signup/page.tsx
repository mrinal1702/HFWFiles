...
export default function SignupPage() {
  ...
  return (
    <main className="mx-auto flex max-w-md flex-1 flex-col px-4 py-8 sm:px-6 sm:py-10">
      <p className="text-center text-sm font-medium text-neutral-400">First time here?</p>
      <h1 className="mt-2 text-center text-2xl font-semibold tracking-tight sm:text-3xl">Create your account</h1>
      ...
      <form onSubmit={onSubmit} className="mt-8 flex flex-col gap-5">
        ...
        <label className="flex flex-col gap-2 text-sm">
          <span className="text-neutral-400">Password (at least 6 characters)</span>
          <input
            name="password"
            type="password"
      ...
      <p className="mt-8 text-center text-sm text-neutral-500">
        ...
        <Link href="/login" className="font-medium text-neutral-300 underline hover:text-white">
          Log in
        </Link>
      </p>
