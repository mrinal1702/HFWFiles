...
import type { Announcement, BuyAnnouncement, ReleaseAnnouncement, TransferAnnouncement } from "@/lib/announcements";
    ...
    <section className="space-y-4 sm:space-y-5">
      ...
      {announcements.length === 0 ? (
        <div className="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm">
          <p className="text-sm text-slate-500">No announcements yet. Check back once bidding is underway.</p>
        </div>
      ) : (
