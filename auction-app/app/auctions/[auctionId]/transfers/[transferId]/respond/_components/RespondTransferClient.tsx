    ...
    <form action={formAction} className="space-y-5">
      ...
      <div>
        <p className="text-sm font-medium text-slate-700">
          ...
          <span className="font-normal text-slate-400">(select any, or none if cash-only)</span>
        </p>
        {mySquad.length === 0 ? (
      ...
      {/* Cash */}
      <div>
        <label htmlFor="recipient_cash" className="block text-sm font-medium text-slate-700">
          Cash to offer{" "}
          <span className="font-normal text-slate-400">(£m, whole number — leave blank for none)</span>
        </label>
        <input
          id="recipient_cash"
          name="recipient_cash"
