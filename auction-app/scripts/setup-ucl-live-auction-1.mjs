/**
 * Creates "UEFA Champions League 2026/27 Auction 1 Live" and seeds UCL player pool.
 *
 * Prerequisites (run once in Supabase SQL Editor if not applied):
 *   scripts/sql/live-auction-dashboard-codes.sql
 *   — or: node scripts/apply-live-auction-dashboard-schema.mjs
 *
 * Usage (from auction-app):
 *   node scripts/setup-ucl-live-auction-1.mjs
 *
...
const AUCTION_NAME = "UEFA Champions League 2026/27 Auction 1 Live";
