...
begin
  ...
  -- For paid releases, verify the window hasn't been used yet
  if p_release_type = 'paid' then
    ...
    perform id from auction_users where id = p_auction_user_id for update;
    v_refund_amount := 0;
  end if;
