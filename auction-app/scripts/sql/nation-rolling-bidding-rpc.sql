...
begin
  ...
  v_rolling_interval := case
    ...
    when p_auction_id = 13 then interval '12 hours'
...
comment on function public.place_bid(bigint, text, bigint, bigint) is
  'Places one bid. global: initiation/raise/hard on Auctions (24h rolling, except auctions 11 and 13 = 12h). nation_rolling: per-nation raise/hard, 12h rolling timer, no initiation.';
