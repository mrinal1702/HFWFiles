-- Competition-aware auction lot seeding.
-- Run in Supabase SQL Editor after competition-isolation migration.
--
-- If the auction has Auctions.competition_id set, lots are seeded from
-- public.competition_players for that competition only.
-- Otherwise falls back to the legacy global public.players pool (EPL-era behaviour).
